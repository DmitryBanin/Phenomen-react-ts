    ...
    <Fragment>
      <section className='main__container'>
        ...
        <p className='main__desc'>
          Since 2019, Phenomen venture has been investing in digital assets and
        ...
        <div className='checkerboard__block'>
          <div className='checkerboard__article checkerboard__article-right'>
            ...
            <p className='checkerboard__article-desc'>
              We are investing in the future, we are not interested in what will
              happen in the next 5 years, we look much further.
            </p>
          </div>
        </div>
        <div className='checkerboard__block'>
          <div className='checkerboard__article checkerboard__article-left'>
            ...
            <p className='checkerboard__article-desc'>
              Our task is to take market share in many innovative areas thathave
        ...
        <ul className='investment__types'>
          <li className='investment__type'>
            <div className='text__type'>
              <h3 className='investment__type-title'>CRYPTOCURRENCY MINING</h3>
          ...
          <li className='investment__type'>
            <div className='text__type'>
              ...
              <p className='investment__type-desc'>
                Familiarity with new, efficient and scalable protocols. Similar
                to venture capital, but investing in tokens (not companies) at
                the private stage at a discount to the listing price.
              </p>
            </div>
          </li>
          <li className='investment__type'>
            <div className='text__type'>
              ...
              <p className='investment__type-desc short'>
                ...
                leverage our deep market and technical expertise to trade tokens
